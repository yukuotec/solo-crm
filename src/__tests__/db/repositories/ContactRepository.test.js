/**
 * ContactRepository 测试
 */

// 创建 mock
const mockDb = { tables: { contacts: [] } };
...
const { ContactRepository } = require('../../../src/db/repositories/ContactRepository');
...
describe('ContactRepository', () => {
  ...
  test('应该能创建实例', () => {
    ...
    expect(repository.tableName).toBe('contacts');
  });
